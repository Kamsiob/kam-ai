// Vendored from sherpa-onnx v1.13.4 (github.com/k2-fsa/sherpa-onnx), the Kotlin
// text-to-speech API, under its Apache-2.0 licence. Kept in the source tree
// rather than fetched because it is small and readable; the native libraries it
// binds to are fetched by tools/fetch_sherpa.sh. Unmodified except this header.
